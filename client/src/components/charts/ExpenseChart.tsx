...
export function ExpenseChart({
  ...
  const lineChartData = useMemo(() => {
    const dailyExpense = entries.reduce((acc, entry) => {
    ...
    return Object.values(dailyExpense).sort(
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="chart-container bg-expense/5 border-2 border-expense/20 flex flex-col items-center justify-center rounded-xl p-4 w-full">
        ...
        <div className="flex-1 overflow-auto">
          <div className="flex gap-4 overflow-hidden bg-expense/5 border-2 border-expense/20 rounded-xl p-4">
