...
// type TimePeriod = 'all' | 'yearly' | 'monthly' | 'quarterly';
...
export function IncomeChart({
  ...
  const entries = useMemo(() => {
    let filteredEntries = allEntries.filter((entry) => entry.type === 'income');
  ...
  const lineChartData = useMemo(() => {
    const dailyIncome = entries.reduce((acc, entry) => {
    ...
    return Object.values(dailyIncome).sort(
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="chart-container bg-income/5 border-2 border-income/20 flex flex-col items-center justify-center rounded-xl p-4">
        ...
        <div className="flex-1 overflow-auto">
          <div className="flex gap-4 overflow-hidden bg-income/5 border-2 border-income/20 rounded-xl p-4">
        ...
        <Card className="py-4 md:col-span-2 sm:py-0 rounded-xl border-income/20 bg-income/5 border-2">
